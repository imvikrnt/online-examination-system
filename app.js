    ...
    connection.query(checkusername, (error, row) => {
        if (error) {
            ...
            if (row.length > 0) {
                ...
                let insertAdmin = "INSERT INTO admin_table(username, password, fullname, email, usertype, statusl) VALUES ('" + username + "', '" + password + "', '" + fullname + "','" + email + "','" + usertype + "', 'active')";
        ...
        if (error) {
            ...
            if (row.length > 0) {
                ...
                photo.mv(serverPath, (e) => {
                    ...
                    let insertInstructor = "INSERT INTO instructor VALUES(null, '" + firstName + "', '" + lastName + "', '" + dbPath + "', '" + email + "', '" + password + "', '" + mobile + "', '" + gender + "', '" + qualification + "','" + address + "','" + experience + "','" + subjects + "', 'Active', null)";
